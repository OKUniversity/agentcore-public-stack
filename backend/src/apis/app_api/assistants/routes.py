...
async def create_assistant_draft_endpoint(request: CreateAssistantDraftRequest, current_user: User = Depends(get_current_user_from_session)):
    """
...
async def create_assistant_endpoint(request: CreateAssistantRequest, current_user: User = Depends(get_current_user_from_session)):
    """
...
async def get_assistant_endpoint(assistant_id: str, current_user: User = Depends(get_current_user_from_session)):
    """
...
async def update_assistant_endpoint(assistant_id: str, request: UpdateAssistantRequest, current_user: User = Depends(get_current_user_from_session)):
    """
...
async def unshare_assistant_endpoint(assistant_id: str, request: UnshareAssistantRequest, current_user: User = Depends(get_current_user_from_session)):
    """
